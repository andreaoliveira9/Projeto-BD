...
-- Lakers players
(1, 'LeBron James', 36, 10001),
(2, 'Anthony Davis', 28, 10002),
(3, 'Russell Westbrook', 32, 10003),
(4, 'Carmelo Anthony', 37, 10004),
(5, 'Malik Monk', 23, 10005),
(6, 'Talen Horton-Tucker', 20, 10006),
(7, 'Dwight Howard', 35, 10007),
(8, 'Wayne Ellington', 33, 10008),
(9, 'DeAndre Jordan', 33, 10009),
(10, 'Kendrick Nunn', 26, 10010),

-- Celtics players
(11, 'Jayson Tatum', 23, 10011),
(12, 'Jaylen Brown', 24, 10012),
(13, 'Al Horford', 35, 10013),
(14, 'Marcus Smart', 27, 10014),
(15, 'Josh Richardson', 27, 10015),
(16, 'Robert Williams III', 23, 10016),
(17, 'Dennis Schroder', 27, 10017),
(18, 'Grant Williams', 23, 10018),
(19, 'Romeo Langford', 21, 10019),
(20, 'Enes Kanter', 29, 10020),

-- Warriors players
(21, 'Stephen Curry', 33, 10021),
(22, 'Klay Thompson', 31, 10022),
(23, 'Draymond Green', 31, 10023),
(24, 'Andrew Wiggins', 26, 10024),
(25, 'James Wiseman', 20, 10025),
(26, 'Kevon Looney', 25, 10026),
(27, 'Jordan Poole', 22, 10027),
(28, 'Damion Lee', 28, 10028),
(29, 'Eric Paschall', 24, 10029),
(30, 'Juan Toscano-Anderson', 28, 10030),
-- Knicks players
(31, 'Julius Randle', 26, 10031),
(32, 'RJ Barrett', 21, 10032),
(33, 'Kemba Walker', 31, 10033),
(34, 'Evan Fournier', 28, 10034),
(35, 'Mitchell Robinson', 23, 10035),
(36, 'Nerlens Noel', 27, 10036),
(37, 'Derrick Rose', 32, 10037),
(38, 'Immanuel Quickley', 22, 10038),
(39, 'Obi Toppin', 23, 10039),
(40, 'Alec Burks', 30, 10040),
-- Bulls players
(41, 'Zach LaVine', 26, 10041),
(42, 'Nikola Vucevic', 30, 10042),
(43, 'DeMar DeRozan', 32, 10043),
(44, 'Lonzo Ball', 23, 10044),
(45, 'Alex Caruso', 27, 10045),
(46, 'Patrick Williams', 20, 10046),
(47, 'Troy Brown Jr.', 22, 10047),
(48, 'Coby White', 21, 10048),
(49, 'Javonte Green', 28, 10049),
(50, 'Tony Bradley', 23, 10050),
-- Heat players
(51, 'Jimmy Butler', 32, 10051),
(52, 'Bam Adebayo', 24, 10052),
(53, 'Kyle Lowry', 35, 10053),
(54, 'Tyler Herro', 21, 10054),
(55, 'Duncan Robinson', 27, 10055),
(56, 'PJ Tucker', 36, 10056),
(57, 'Marquis Teague', 28, 10057),
(58, 'Dewayne Dedmon', 32, 10058),
(59, 'Max Strus', 25, 10059),
(60, 'Goran Dragic', 35, 10060),
-- Mavericks players
(61, 'Luka Doncic', 22, 10061),
(62, 'Kristaps Porzingis', 26, 10062),
(63, 'Tim Hardaway Jr.', 29, 10063),
(64, 'Dwight Powell', 30, 10064),
(65, 'Jalen Brunson', 25, 10065),
(66, 'Josh Green', 20, 10066),
(67, 'Maxi Kleber', 29, 10067),
(68, 'Dorian Finney-Smith', 28, 10068),
(69, 'Trey Burke', 28, 10069),
(70, 'Willie Cauley-Stein', 28, 10070),
-- Spurs players
(71, 'Dejounte Murray', 25, 10071),
(72, 'Derrick White', 27, 10072),
(73, 'Jakob Poeltl', 26, 10073),
(74, 'Keldon Johnson', 22, 10074),
(75, 'Lonnie Walker IV', 22, 10075),
(76, 'Thaddeus Young', 33, 10076),
(77, 'Joshua Primo', 18, 10077),
(78, 'Doug McDermott', 29, 10078),
(79, 'Bryn Forbes', 28, 10079),
(80, 'Devin Vassell', 20, 10080),
-- Rockets players
(81, 'Christian Wood', 26, 10081),
(82, 'Jalen Green', 19, 10082),
(83, 'Kevin Porter Jr.', 21, 10083),
(84, 'Jae''Sean Tate', 25, 10084),
(85, 'Daniel Theis', 29, 10085),
(86, 'Eric Gordon', 32, 10086),
(87, 'Alperen Sengun', 19, 10087),
(88, 'David Nwaba', 28, 10088),
(89, 'Armoni Brooks', 22, 10089),
(90, 'D.J. Augustin', 33, 10090),
-- Trail Blazers players
(91, 'Damian Lillard', 31, 10091),
(92, 'CJ McCollum', 29, 10092),
(93, 'Norman Powell', 28, 10093),
(94, 'Robert Covington', 30, 10094),
(95, 'Jusuf Nurkic', 27, 10095),
(96, 'Anfernee Simons', 22, 10096),
(97, 'Larry Nance Jr.', 28, 10097),
(98, 'Cody Zeller', 29, 10098),
(99, 'Tony Snell', 29, 10099),
(100, 'Nassir Little', 21, 10100),
-- Treinadores
(1001, 'Frank Vogel', 48, 10101),
(1002, 'Steve Kerr', 56, 10102),
(1003, 'Tom Thibodeau', 63, 10103),
(1004, 'Billy Donovan', 56, 10104),
(1005, 'Erik Spoelstra', 51, 10105),
(1006, 'Jason Kidd', 48, 10106),
(1007, 'Gregg Popovich', 72, 10107),
(1008, 'Stephen Silas', 48, 10108),
(1009, 'Chauncey Billups', 45, 10109),
(1010, 'Terry Stotts', 64, 10110);
...
insert into NBA.Team (ID, [Name], [Owner], City, Conference, Found_Year, Coach_CCNumber) values
(1, 'Los Angeles Lakers', 'Jeanie Buss', 'Los Angeles', 'Western', 1947, 1001),
(2, 'Boston Celtics', 'Wyc Grousbeck', 'Boston', 'Eastern', 1946, 1002),
(3, 'Golden State Warriors', 'Joe Lacob', 'San Francisco', 'Western', 1946, 1003),
(4, 'New York Knicks', 'James Dolan', 'New York', 'Eastern', 1946, 1004),
(5, 'Chicago Bulls', 'Jerry Reinsdorf', 'Chicago', 'Eastern', 1966, 1005),
(6, 'Miami Heat', 'Micky Arison', 'Miami', 'Eastern', 1988, 1006),
(7, 'Dallas Mavericks', 'Mark Cuban', 'Dallas', 'Western', 1980, 1007),
(8, 'San Antonio Spurs', 'Peter Holt', 'San Antonio', 'Western', 1967, 1008),
(9, 'Houston Rockets', 'Tilman Fertitta', 'Houston', 'Western', 1967, 1009),
(10, 'Portland Trail Blazers', 'Jody Allen', 'Portland', 'Western', 1970, 1010);
